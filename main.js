...
function addli(elm) {
    document.querySelector('ul').innerHTML += '<li class="box-soignant"><svg width="24" height="24" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d=" M 350 625C 350 625 350 625 350 625C 350 625 453 870 453 870C 457 815 454 764 475 700C 465 700 450 690 450 675C 450 664 451 655 454 648C 468 649 480 649 501 649C 520 649 533 649 546 648C 549 655 550 664 550 675C 550 689 542 700 525 700C 546 764 543 815 547 870C 547 870 654 625 654 625C 757 625 792 647 831 725C 738 830 625 900 500 900C 375 900 232 817 173 730C 212 652 247 625 350 625M 501 129C 501 129 501 129 501 129C 624 129 724 229 724 352C 724 475 624 575 501 575C 378 575 278 475 278 352C 278 229 378 129 501 129"/></svg></i>' + soignant[elm].nom + '<p> Telephone : <span>' + soignant[elm].telephone + '</span></p></li>'
}
